function getChargeTypeList() {
    ...
    ChargeTypeList.push({ ID: 1, Name: "单价*计算面积*月数" });
    ChargeTypeList.push({ ID: 7, Name: "(单价*计算面积)四舍五入*月数" });
    ChargeTypeList.push({ ID: 5, Name: "单价*计算面积*天数" });
    ChargeTypeList.push({ ID: 3, Name: "单价*计算面积*公摊系数*月数" });
    ChargeTypeList.push({ ID: 2, Name: "定额(月)" });
    ChargeTypeList.push({ ID: 4, Name: "定额(年)" });
    ChargeTypeList.push({ ID: 6, Name: "单价*计算面积/用量(一次性)" });
